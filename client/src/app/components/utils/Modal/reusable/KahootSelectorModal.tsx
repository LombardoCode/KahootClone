...
const KahootSelectorModal = ({ isOpen, onClose, selectedKahootId }: KahootSelectorModalProps) => {
  ...
  const [errorWhenRetrievingKahoot, setErrorWhenRetrievingKahoot] = useState<boolean>(false);
  ...
  const getKahootMetadata = async () => {
    setLoading(true);
    setErrorWhenRetrievingKahoot(false);
    ...
    await axiosInstance.get('/kahoot/getKahootMetadata', {
      ...
      .catch(err => {
        setErrorWhenRetrievingKahoot(true);
        console.error(err);
      })
              ...
              {errorWhenRetrievingKahoot ? (
                <>
                  ...
                  <Text
                    ...
                    className="text-lg"
                  >
                    There was an error when retrieving Kahoot. Please try again later.
                  </Text>
                </>
              ) : (
                <div
